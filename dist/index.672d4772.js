...
class App {
    ...
    _newWorkOut(e) {
        ...
        if (type == "running") {
            ...
            if (!validInput(distance, duration, cadence) || !positiveInput(distance, duration, cadence)) return alert("Inputs must be positive number");
            workout = new Running([
                lat,
                lng
        ...
        if (type == "cycling") {
            ...
            if (!validInput(distance, duration, elevation) || !positiveInput(distance, duration)) return alert("Inputs must be number");
            workout = new Cycling([
                lat,
                lng
    ...
    _renderWorkout(workout) {
        ...
        `;
        if (workout.type === "running") workoutHtml += `
            <div class="workout__details">
          ...
          <div class="workout__details">
            ...
            `;
        if (workout.type === "cycling") workoutHtml += `
            <div class="workout__details">
            <span class="workout__icon">⚡️</span>
    ...
    _moveToMaker(e) {
        ...
        const workout = this.#workouts.find((work)=>work.id === workoutClass.dataset.id);
        console.log(workout);
